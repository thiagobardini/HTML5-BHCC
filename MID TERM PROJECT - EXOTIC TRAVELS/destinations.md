...
<html>
  ...
  #BOXimg2
  {
    width:300px;
    height:180px;
    background-image: url('http://tourplans.com/wp-content/uploads/2016/07/fernando-de-noronha.jpg');
    background-size: cover;
    float: left;
    margin-right: 13px;
  }
  ...
  #BOXimg3
  {
    width:320px;
    height:180px;
    background-image: url('https://userscontent2.emaze.com/images/67e4e34b-6b10-4560-8189-2373a59bfa0d/0cc3a7639a0a38028390be40efd86cad.jpg');
    background-size: cover;
    float: left;
    margin-right: 13px;
  }
...
<div id="container"><!--start container-->
  ...
  <div id="HOLDER3"><!--start HOLDER3-->
      ...
      <p>Florianópolis, the capital of Santa Catarina state, is know throughout Brazil for its miles and miles of gourgeous beaches, excellent seafood and traditional Azorean fishing villages.</p>
