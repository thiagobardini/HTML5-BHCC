# Contact Us page
- [Click here to see the full website](http://www.media15live.com/studentsUpload/BARDINI_1585582065/contactus.htm)
...
<html>
  ...
  #BOXimg2
  {
    width:600px;
    height:300px;
    background-image: url('https://www.ozotours.com/assets/images/Contact.jpg');
    background-size: cover;
    float: left;
    margin-right: 13px;
    margin-bottom: 80px;
  ...
  #email
  {
    width:90px;
    height:90px;
    background-image: url('https://cdn0.iconfinder.com/data/icons/material-set-7-2/48/668-512.png');
    background-size: cover;
    float: left;
    margin-top: 15px;
  }
  ...
  #phone
  {
    width:90px;
    height:90px;
    background-image: url('https://i.pinimg.com/236x/a1/92/11/a192119d3e87adffb6877d3e26efe93d.jpg');
    background-size: cover;
    float: left;
  }
...
<div id="container"><!--start container-->
  ...
  <div id="HOLDER3"><!--start HOLDER3-->
        <div id="BOXimg2">
            <div id="boximg2TEXT">
              <font size="6" face="fantasy" color="#afafaf">Exotic</font><font size="6" color="#676867" face="fantasy"><b>Travel</b></font></font>
            </div>
      </div>
  </div><!--end HOLDER3-->

  <div id="HOLDER4"><!--start HOLDER4-->

      <div id="phone"></div>
      <div id="email"></div>
  </div><!--end HOLDER4-->
  <div id="HOLDER5"><!--start HOLDER5-->
    <p><font size="6"><b>978-648-7075</b></font></li></p>
    <br><br><br>
    <p><font size="6"><b>contact@exotictravel.com</b></font></li></p>
  </div><!--end HOLDER5-->
