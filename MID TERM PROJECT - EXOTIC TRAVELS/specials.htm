# Specials PAGE
- [Click here to see the full website](http://www.media15live.com/studentsUpload/BARDINI_1585582065/specials.htm)

![Team Page](https://github.com/thiagobardini/HTML5-CSS-BHCC/blob/master/Imagens/special.png)
...
<html>
  ...
  #BOXimg2
  {
    width:300px;
    height:180px;
    background-image: url('http://tourplans.com/wp-content/uploads/2016/07/fernando-de-noronha-beach.jpg');
    background-size: cover;
    float: left;
    margin-right: 25px;
  }
  ...
  #BOXimg3
  {
    width:320px;
    height:180px;
    background-image: url('https://admin.freetour.com/images/tours/1760/lagoinha-do-leste-hiking-13.jpg');
    background-size: cover;
    float: left;
    margin-right: 25px;
  }
...
<div id="container"><!--start container-->
  ...
  <div id="HOLDER3"><!--start HOLDER3-->
      <div id="BOX2"><div id="BOXimg2"></div><font color='red' size="5"><p><b>Fernando de Noronha </b></font><br>
      <font size="3"> Pernambuco, Brazil</font></p>
      <p></p>
        <p><font color='orange' size="5">5 Nights from $1200*</font></li></p>
      <p></p>
      <ul>
          <li>All-inclusive resort</li>
          <li>Westin® Kids Club</li>
          <li>$50 Spa credit</li>
      </ul>
      ...
      <div id="BOX3"><div id="BOXimg3"></div><font color='red' size="5"><p><b>Florianópolis </b></font><br>
      <font size="3"> Santa Catarina, Brazil</font></p>
      <p></p>
        <p><font color='orange' size="5">8 Nights from $839*</font></li></p>
      <p></p>
      <ul>
          <li>All-inclusive resort</li>
          <li>Westin® Kids Club</li>
